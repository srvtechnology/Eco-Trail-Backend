...
{
    $query = EcoTrailMainSpace::with('CatDetails')->orderBy('id', 'desc');
 ...
 public function storeOld(Request $request)
{
    $validator = Validator::make($request->all(), [
        ...
        // 'nearby_places.*.latitude' => 'required',
        // 'nearby_places.*.longitude' => 'required',
    ...
    $mainSpace = EcoTrailMainSpace::create([
        ...
        'latlong_info'=>json_encode(@$request->latlong_info),
    ]);
   ...
   public function updateOld(Request $request, $id)
{
    ...
    public function getAllLatLong(){
        $locations = EcoTrailMainSpace::select('latitude', 'longitude','place_name','latlong_info')->get();
    ...
    public function getAllCount(){
        $data['locations'] = EcoTrailMainSpace::count();
        $data['cat']=SpaceCategory::count();
        $data['user']=User::where('user_type','user')->count();
         return response()->json([
            'status' => 'success',
            'data' => $data,
        ]);
